...
class ExperimentBuilder(nn.Module):
    def __init__(self, network_model,learning_rate, experiment_name, num_epochs, train_data, val_data,
        ...
        :param learning_rate: The learning rate of optimizer.
