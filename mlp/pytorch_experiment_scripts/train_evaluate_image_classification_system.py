...
elif args.block_type == 'conv_with_bn_block':
    processing_block_type = ConvolutionalProcessingWithBatchNormBlock
    dim_reduction_block_type = ConvolutionalDimensionalityReductionWithBatchNormBlock
else:
