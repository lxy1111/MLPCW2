...
class ConvolutionalProcessingWithBatchNormBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingWithBatchNormBlock, self).__init__()
...
class ConvolutionalDimensionalityReductionWithBatchNormBlock(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionWithBatchNormBlock, self).__init__()
